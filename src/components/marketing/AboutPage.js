		...
		<section>
			...
			<div>
				...
				<p className='about-para'>
					Every team member contributed to the project with young children in mind but the App has potential to grow into
					something from small children to Technical Schools and College Students would love to use. Every member contributed
					to all elements of both the Front End and Back End
				</p>
			</div>
