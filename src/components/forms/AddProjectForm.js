	...
	return (
		<AddEditContainer>
			<Form>
				...
				<br />
				<FormContainer onSubmit={props.editProjectStart ? editForm : submitForm}>
					...
					{(props.postProjectError || props.saveEditProjectError) && (
						<p style={{ color: 'red', textAlign: 'center', marginTop: '10px' }}>Well, looks like the Project was Not saved</p>
					)}
				</FormContainer>
			</Form>
		</AddEditContainer>
